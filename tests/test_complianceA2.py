...
class A211(APITestCase):
    ...
    # todo: separate compliance tests from unit tests
    ...
    # todo: need to test if this is done after pagination
    @skip("Skipping test of feature that is not yet implemented")
...
class A214(APITestCase):
    ...
    def test_orderby4(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data['value']), 6)
        self.assertTrue(response.data['value'][0]['@iot.id'] < response.data['value'][-1]['@iot.id'])
...
class A216(APITestCase):
    ...
    def test_filter_spatial_within1(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data['value']), 5)
        self.assertContains(response, "Location 3", 1)
